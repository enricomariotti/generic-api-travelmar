 ...
 */
public class GetDisponibilitaResultImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements reservation.GetDisponibilitaResult
{
    private static final long serialVersionUID = 1L;
    
    public GetDisponibilitaResultImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public reservation.TratteResultArray getData()
    {
        synchronized (monitor())
        {
            check_orphaned();
            reservation.TratteResultArray target = null;
            target = (reservation.TratteResultArray)get_store().find_element_user(DATA$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setData(reservation.TratteResultArray data)
    {
     ...
     */
    public reservation.TratteResultArray addNewData()
    {
        synchronized (monitor())
        {
            check_orphaned();
            reservation.TratteResultArray target = null;
            target = (reservation.TratteResultArray)get_store().add_element_user(DATA$2);
            return target;
        }
    }
